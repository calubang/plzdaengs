...
<html>
  <head>
    ...
    <!-- theme stylesheet-->
    <link rel="stylesheet" href="/plzdaengs/template/css/style.default.css" id="theme-stylesheet">
      ...
      <div class="page-holder w-100 d-flex flex-wrap">
        <div class="container-fluid px-xl-5" id="contents">
          <section class="py-5" style="max-height: none;">
            ...
            <div class="col-md-12 select mb-2">
              <select name="account" class="form-control col-md-2">
                    <option>제목</option>
                    <option>작성자</option>
              </select>
              <input type="text" class="form-control is-valid col-md-7">
            </div>
          </section>
        </div>
