...
$(function() {
	//동물 품종 등록
	$("#petkindregisterBtn").click(petkindregisterClick);
});

function petkindregisterClick() {
	alert("눌림");
	$.ajax({
		url : "/plzdaengs/admin"
		, data : {
	...
	<div class="d-flex align-items-stretch" id="document">
		...
		<div class="page-holder w-100 d-flex flex-wrap">
			<div class="container-fluid" id="contents">
				<!-- section 1 -->
				<section class="py-5 admin">
					<button class="btn btn-info" id="petkindregisterBtn">강아지 품종 등록</button>
				</section>
			</div>
